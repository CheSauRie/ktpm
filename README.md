...
Xây dựng hệ thống microservice với các yêu cầu trên và thêm 1 số yêu cầu sau
- Thêm kafka để handle add dữ liệu vào queue, 
- Sử dụng cassandra ORM 
- Sử dụng pattern phù hợp với hiệu năng cao 
